...
- [Extensions compatibility](https://github.com/clad-solutions/clad_ide_void/blob/master/docs/extensions-compatibility.md)
- [Migrating from Visual Studio Code to VSCodium](#migrating)
- [Sign in with GitHub](#signin-github)
- [Accounts authentication](https://github.com/clad-solutions/clad_ide_void/blob/master/docs/accounts-authentication.md)
...
- [Troubleshooting](https://github.com/clad-solutions/clad_ide_void/blob/master/docs/troubleshooting.md)
- [Contributing](https://github.com/clad-solutions/clad_ide_void/blob/master/CONTRIBUTING.md)
- [How to build VSCodium](https://github.com/clad-solutions/clad_ide_void/blob/master/docs/howto-build.md)
...
When searching the `@tag:usesOnlineServices` filter, note that while the "Update: Mode" setting description still says "The updates are fetched from a Microsoft online service", Clad's build script [sets the `updateUrl` field](https://github.com/clad-solutions/clad_ide_void/blob/master/prepare_vscode.sh#L36) in `product.json` to use Clad's own update system, so enabling that setting won't actually result in any calls to Microsoft servers.

Likewise, while the descriptions for "Extensions: Auto Check Updates" and "Extensions: Auto Update" include the same phrase, Clad [replaces](https://github.com/clad-solutions/clad_ide_void/blob/master/prepare_vscode.sh#L42) the Visual Studio Marketplace with Open VSX, so these settings won't call Microsoft, either.
...
A workaround exists to get debugging working in C# projects, by using Samsung's opensource [netcoredbg](https://github.com/Samsung/netcoredbg) package.
