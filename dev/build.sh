...
export APP_NAME="Clad"
export BINARY_NAME="clad"
export CI_BUILD="no"
export GH_REPO_PATH="clad-solutions/clad_ide_void"
export ORG_NAME="clad-solutions"
...
while getopts ":ilops" opt; do
  case "$opt" in
    i)
      export BINARY_NAME="clad-insiders"
